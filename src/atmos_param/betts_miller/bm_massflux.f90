...
use      constants_mod, only:  HLv,HLs,Cp_air,Grav,rdgas,rvgas, cph2ovapor, kappa
...
!   ---- version number ----
 ...
 character(len=128) :: version = '$Id: bm_massflux.f90,v 1.1.2.1 2005/05/13 18:26:51 pjp Exp $'
...
! code
!             call capecalc( Cp_air, cph2ovapor, d622, kx, pfull(i,j,:),&
...
!---------- output namelist --------------------------------------------
      ...
      if ( mpp_pe() == mpp_root_pe() ) then
           write (stdlog(),nml=bm_massflux_nml)
      endif
